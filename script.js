(function () {
  ...
  const PARTICIPANTS = [
    ...
    { id:4,  key:"Idit_Ayala_Reiss",         nameEn:"Idit Ayala Reiss",         nameHe:"עידית אילה ריס",       sector:"Central Government", org:"Ministry of Justice",                  orgHe:"משרד המשפטים",                    role:"Adv., Office of Legal Counsel and Legislative Affairs", roleHe:"עו״ד ייעוץ וחקיקה",                 email:"iditna@justice.gov.il" },
    { id:5,  key:"Jasmin_Vulej",             nameEn:"Jasmin Vulej",             nameHe:"יסמין וולג'י",         sector:"Central Government", org:"Ministry of Social Affairs",            orgHe:"משרד הרווחה",                     role:"Head of Model Development Unit",               roleHe:"מנהלת יחידת פיתוח מודלים",           email:"jasminv@molsa.gov.il" },
    { id:6,  key:"Liat_Stark",               nameEn:"Liat Stark",               nameHe:"ליאת שטרק",            sector:"Central Government", org:"Ministry of Justice",                  orgHe:"משרד המשפטים",                    role:"District Director, Guardian General",          roleHe:"מנהלת מחוז ירושלים אפוטרופוס כללי",  email:"liatsta@justice.gov.il" },
    { id:7,  key:"Lior_Zohar",               nameEn:"Lior Zohar",               nameHe:"ליאור זוהר",            sector:"Central Government", org:"Ministry of Finance",                  orgHe:"משרד האוצר",                      role:"Head of Strategy and Pension Consultation Dept.", roleHe:"מנהלת תחום אסטרטגיה וייעוץ פנסיוני", email:"liork@mof.gov.il" },
    { id:8,  key:"Rachela_Akuka",            nameEn:"Rachela Akuka",            nameHe:"רחלה אקוקה",            sector:"Central Government", org:"Tax Authority",                        orgHe:"רשות המיסים",                     role:"Head Muster",                                  roleHe:"מנהלת מחלקת שומה",                   email:"akuka720@gmail.com" },
    { id:9,  key:"Ravit_Nakar_El-Ezra",      nameEn:"Ravit Nakar El-Ezra",      nameHe:"רוית נקר אל-עזרא",    sector:"Central Government", org:"Ministry of Welfare and Social Security", orgHe:"משרד הרווחה והביטחון החברתי",    role:"Senior Manager, Budgeting and Pricing, Senior Citizens Administration", roleHe:"מנהלת בכירה תקצוב ותמחור אגף אזרחים ותיקים", email:"ravitn@molsa.gov.il" },
    { id:10, key:"Roei_Rafael_Babai",        nameEn:"Roei Rafael Babai",        nameHe:"רועי רפאל בבאי",       sector:"Central Government", org:"Ministry of Finance",                  orgHe:"משרד האוצר",                      role:"National Social Insurance Referent, Budget Dept.", roleHe:"רפרנט ביטוח לאומי, אגף התקציבים", email:"roeib@mof.gov.il" },
    { id:11, key:"Ronit_Rozin",              nameEn:"Ronit Rozin",              nameHe:"רונית רוזין",           sector:"Central Government", org:"Prime Minister Office",                orgHe:"משרד ראש הממשלה",                 role:"CEO Holocaust Survivors Authority",            roleHe:"מנכ״לית הרשות לניצולי שואה",         email:"ronitro@hsa.gov.il" },
    { id:12, key:"Valentina_Batia_Chai",     nameEn:"Valentina Batia Chai",     nameHe:"ולנטינה בתיה חי",       sector:"Central Government", org:"National Insurance Institute",          orgHe:"המוסד לביטוח לאומי",              role:"Branch Manager",                             roleHe:"מנהלת סניף",                           email:"valic1110@gmail.com" },
    { id:13, key:"Yehuda_Arie_Halali",       nameEn:"Yehuda Arie Halali",       nameHe:"יהודה אריה הללי",      sector:"Central Government", org:"National Insurance Institute",          orgHe:"המוסד לביטוח לאומי",              role:"Senior Citizens Call Center Dept. Manager",    roleHe:"מנהל מחלקת מוקד אזרחים ותיקים",    email:"ci00734@gmail.com" },
    { id:14, key:"Alon_Kalman",              nameEn:"Alon Kalman",              nameHe:"אלון קלמן",             sector:"Civil Society",      org:"Gil‑Ad Geriatric Center",              orgHe:"מרכז גריאטרי גיל-עד",             role:"CEO",                                          roleHe:'מנכ"ל',                               email:"alon.k@giladc.co.il" },
    { id:15, key:"Eden_Chen",                nameEn:"Eden Chen",                nameHe:"עדן חן",                sector:"Civil Society",      org:"Yesodot Letzmicha Dror NGO",           orgHe:"יסודות לתמיכה דרור עמותה",       role:"Director Dror Senior Community Network",       roleHe:"מנהלת רשת קהילות דרור",               email:"eden-c@drorzikna.org.il" },
    { id:16, key:"Josef_Kaplan",             nameEn:"Josef Kaplan",             nameHe:"יוסף קפלן",             sector:"Civil Society",      org:"Lev Ganim Senior Living",              orgHe:"לב גנים מגורים לגיל השלישי",     role:"CEO",                                          roleHe:'מנכ"ל',                               email:"kaplan@levganim.co.il" },
    { id:17, key:"Liat_Sikron_Vazan",        nameEn:"Liat Sikron Vazan",        nameHe:"ליאת סיקרון וזאן",      sector:"Civil Society",      org:"JDC‑Eshel",                            orgHe:"ג'וינט ישראל – אשל",              role:"Head of Knowledge and Learning Center",        roleHe:"ראש מרכז ידע ולמידה",               email:"liats@jdc.org.il" },
    { id:18, key:"Yael_Barkan_Dolev",        nameEn:"Yael Barkan Dolev",        nameHe:"יעל ברקן דולב",         sector:"Civil Society",      org:"Gil Oz Organization",                  orgHe:"עמותת גיל עוז",                   role:"CEO",                                          roleHe:"מנכ״לית",                             email:"yael@giloz.co.il" },
    { id:19, key:"Adaya_Nissenholtz",        nameEn:"Adaya Nissenholtz",        nameHe:"עדיה ניסנהולץ",        sector:"Health System",      org:"Clalit Health Services",               orgHe:"כללית שירותי בריאות",             role:"Regional Geriatrician",                        roleHe:"גריאטרית מחוזית",                   email:"adayani@clalit.org.il" },
    { id:20, key:"Dalit_Cypel",              nameEn:"Dalit Cypel",              nameHe:"דלית ציפל",            sector:"Health System",      org:"Clalit Health Services",               orgHe:"כללית שירותי בריאות",             role:"Head of Geriatrics Field",                     roleHe:"ראש תחום גריאטריה",                 email:"dalitcy@gmail.com" },
    { id:21, key:"Galit_Segal",              nameEn:"Galit Segal",              nameHe:"גלית סגל",              sector:"Health System",      org:"Meuhedet HMO",                        orgHe:"קופת חולים מאוחדת",               role:"Chief Geriatric Physician",                    roleHe:"גריאטרית ראשית",                     email:"galit.s4@meuhedet.co.il" },
    { id:22, key:"Netanel_Levi",             nameEn:"Netanel Levi",             nameHe:"נתנאל לוי",             sector:"Health System",      org:"Shoham Medical Center",                orgHe:"המרכז הרפואי שוהם",               role:"Head of Physical Therapy Department",          roleHe:"מנהל שירותי פיזיותרפיה",             email:"netanell@shoham.health.gov.il" },
    { id:23, key:"Suaad_Ektelat",            nameEn:"Suaad Ektelat",            nameHe:"סואעד אקטילאת",        sector:"Health System",      org:"Beer Yaakov–Ness Ziona Mental Health Center", orgHe:"מרכז לבריאות הנפש באר יעקב-נס ציונה", role:"Adult‑Gerontology Nurse Practitioner",  roleHe:"אחות מומחית גרונטולוגית",          email:"somaa.h84@gmail.com" },
    { id:24, key:"Galit_Groper",             nameEn:"Galit Groper",             nameHe:"גלית גרופר",            sector:"Local Government",   org:"Emek Hefer Regional Council",          orgHe:"מועצה אזורית עמק חפר",            role:"Head of Social Services and Health Dept.",     roleHe:"מנהלת אגף רווחה ובריאות",            email:"galitgr@hefer.org.il" },
    { id:25, key:"Michal_Schwartz",          nameEn:"Michal Schwartz",          nameHe:"מיכל שוורץ",            sector:"Local Government",   org:"Rishon LeZion Municipality",           orgHe:"עיריית ראשון לציון",             role:"Director Senior Citizens Dept.",               roleHe:"מנהלת אגף אזרחים ותיקים",             email:"micalsw@rishonlezion.muni.il" },
    { id:26, key:"Nes-Ya_Strasburg",         nameEn:"Nes-Ya Strasburg",         nameHe:"נס-יה שטרסבורג",       sector:"Local Government",   org:"Southern Soreq Cluster",               orgHe:"מרחב שורק דרומי",                 role:"Optimal Aging Regional Director",             roleHe:"מנהלת אזורית להזדקנות מיטבית",      email:"nesyas2222@gmail.com" },
