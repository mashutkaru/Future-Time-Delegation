(function () {
  ...
  const PARTICIPANTS = [
    ...
    { id:9,  key:"Ravit_Nakar_El-Ezra",      nameEn:"Ravit Nakar El-Ezra",      nameJa:"ナカル・エルエズラ・ラヴィット",     nameHe:"רוית נקר אל-עזרה",    sector:"Central Government", org:"The Ministry of Welfare and Social Affairs", orgHe:"משרד הרווחה והביטחון החברתי",    role:"Senior Head, Budgeting and Pricing, Senior Citizens Administration", roleHe:"מנהלת בכירה תקצוב ותמחור אגף אזרחים ותיקים", email:"ravitn@molsa.gov.il" },
    ...
    { id:19, key:"Adaya_Nissenholtz",        nameEn:"Dr. Adaya Nissenholtz",        nameJa:"ニッセンホルツ・アダヤ",             nameHe:"עדיה ניסנהולץ",        sector:"Healthcare System",      org:"Clalit Health Services",               orgHe:"כללית שירותי בריאות",             role:"Regional Geriatrician",                        roleHe:"גריאטרית מחוזית",                   email:"adayani@clalit.org.il" },
    { id:20, key:"Dalit_Cypel",              nameEn:"Dalit Cypel",              nameJa:"ツィペル・ダリット",               nameHe:"דלית ציפל",            sector:"Healthcare System",      org:"Clalit Health Services",               orgHe:"כללית שירותי בריאות",             role:"Head of Geriatrics, Community Nursing Department, Clalit Health Services", roleHe:"ראש תחום גריאטריה",                 email:"dalitcy@gmail.com" },
    { id:21, key:"Galit_Segal",              nameEn:"Dr. Galit Segal",              nameJa:"セガル・ガリット",                 nameHe:"גלית סגל",              sector:"Healthcare System",      org:"Meuhedet HMO",                        orgHe:"קופת חולים מאוחדת",               role:"Chief Geriatric Physician",                    roleHe:"גריאטרית ראשית",                     email:"galit.s4@meuhedet.co.il" },
    ...
    { id:24, key:"Galit_Groper",             nameEn:"Dr. Galit Groper",             nameJa:"グローパー・ガリット",             nameHe:"גלית גרופר",            sector:"Local Government",   org:"Emek Hefer Regional Council",          orgHe:"מועצה אזורית עמק חפר",            role:"Head of Social Services and Health Department",     roleHe:"מנהלת אגף רווחה ובריאות",            email:"galitgr@hefer.org.il" },
    ...
    { id:28, key:"Shirli_Reznizky_Kahan",    nameEn:"Dr. Shirli Reznizky Kahan",    nameJa:"カハン・シルリ",                   nameHe:"שירלי רזניצקי קאהן",    sector:"Academia & Research", org:"Myers JDC Brookdale Institute",        orgHe:"מכון מאיירס-ג'וינט-ברוקדייל",    role:"Senior Research Scholar and Aging Team Leader", roleHe:"חוקרת בכירה וראש צוות הזדקנות",    email:"shirlir@jdc.org" },
    { id:29, key:"Shmuel_Springer",          nameEn:"Professor Shmuel Springer",          nameJa:"スプリンガー・シュムエル",           nameHe:"שמואל שפרינגר",         sector:"Academia & Research", org:"Ariel University",                      orgHe:"אוניברסיטת אריאל",                role:"Head Academic Community Partnership Unit",     roleHe:"ראש יחידת קשרי אקדמיה קהילה",       email:"shmuels@ariel.ac.il" },
  ...
  const PROGRAM_TEAM = [
    { id:"pt1", key:"Yuval_Golani", nameEn:"Yuval Golani", nameJa:"ゴラニ・ユヴァル", nameHe:"יובל גולני", jaTitle:"ゴラニ・ユヴァル", org:"Joint-ELKA", orgJa:"Joint-ELKA（JDC-ELKA）", role:"Coordinator, \"FutureTime\" Program", roleJa:"FutureTimeプログラム コーディネーター", photo:"Yuval_Golani.png", photoVer:4,
      bioEn:[
    ...
    { id:"pt2", key:"Sigal_Mautner", nameEn:"Sigal Mautner Siebzehner", nameJa:"マウトナー・シーブツェナー・シガル", nameHe:"סיגל מאוטנר זיבצנר", jaTitle:"マウトナー・シーブツェナー・シガル", org:"Joint-ELKA", orgJa:"Joint-ELKA（JDC-ELKA）", role:"Director, \"FutureTime\" Program", roleJa:"FutureTimeプログラム ディレクター", photo:"Sigal_Mautner_Sievzehner.jpeg",
      bioEn:[
    ...
    { id:"pt3", key:"Hadas_Barzilai", nameEn:"Hadas Barzilai", nameJa:"バルジライ・ハダス", nameHe:"הדס ברזילי", jaTitle:"バルジライ・ハダス", org:"Joint-ELKA", orgJa:"Joint-ELKA（JDC-ELKA）", role:"Director, \"FutureTime\" Program", roleJa:"FutureTimeプログラム ディレクター", photo:"Hadas_Barzilai.jpg",
      bioEn:[
    ...
    { id:"pt4", key:"Tal_Miles", nameEn:"Tal Miles", nameJa:"マイルズ・タル", nameHe:"טל מילס", jaTitle:"マイルズ・タル", org:"Joint-ELKA", orgJa:"Joint-ELKA（JDC-ELKA）", role:"Director, National Public System Network Initiatives", roleJa:"全国公共システム・ネットワーク・イニシアティブ ディレクター", photo:"Tal_Miles.png", photoVer:4,
      bioEn:[
